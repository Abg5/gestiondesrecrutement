    ...
    <aside id="sidebar-multi-level-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
            <ul class="space-y-4 font-medium">
                ...
                <li>
                    <a href="{{ route('departementmathematique') }}"
                ...
                <li>
                    ...
                    <a href="{{ route('designationmathematique') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                 ...
                 <li>
                    <a href="{{ route('ajoutdescriptionmathematique') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                     <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                     xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray"
                     viewBox="0 0 24 24">
  ...
  <path fill-rule="evenodd" d="M17.447 8.08a1.087 1.087 0 0 1 1.187.238l.002.001a1.088 1.088 0 0 1 0 1.539l-.377.377-1.54-1.542.373-.374.002-.001c.1-.102.22-.182.353-.237Zm-2.143 2.027-4.644 4.644-.385 1.924 1.925-.385 4.644-4.642-1.54-1.54Zm2.56-4.11a3.087 3.087 0 0 0-2.187.909l-6.645 6.645a1 1 0 0 0-.274.51l-.739 3.693a1 1 0 0 0 1.177 1.176l3.693-.738a1 1 0 0 0 .51-.274l6.65-6.646a3.088 3.088 0 0 0-2.185-5.275Z" clip-rule="evenodd"/>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-1 rounded-lg ">
            ...
            <div class="container">
    <div class="header">
        <h1>Tableau de Bord du Département</h1>
    </div>
    <div class="content">
        <p>Bienvenue sur le tableau de bord du département de l'Université Alioune Diop de Bambey. Ce tableau de bord est conçu pour vous aider à gérer les tâches importantes de votre département. En tant que chef de département, vous avez les rôles et responsabilités suivants :</p>

        <h2>Décrire et Fixer les Missions du Profil Recherché</h2>
        <p>Définissez clairement les missions et les compétences requises pour chaque profil recherché dans votre département.</p>

        <h2>Désigner les Membres de la Commission</h2>
        <p>Sélectionnez et nommez les membres de la commission chargée d'évaluer les candidatures et de mener les entretiens.</p>

        <p>Nous vous remercions pour votre engagement à maintenir un haut niveau de qualité dans la gestion de votre département et la sélection des meilleurs candidats.</p>
    </div>
</div>
