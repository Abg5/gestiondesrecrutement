        ...
        <form method="POST" action="{{ route('update', ['id' => $user->id]) }}">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                <div class="sm:col-span-2">
                    <label for="prenom" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nouveau Prénom</label>
                ...
                <div class="sm:col-span-2">
                    <label for="nom" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nouveau Nom</label>
