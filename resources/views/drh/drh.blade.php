...
<div class="container">
    <div class="header">
        <h1>Tableau de Bord du DRH</h1>
    </div>
    <div class="content">
        <p>Bienvenue sur le tableau de bord de la Direction des Ressources Humaines de l'Université Alioune Diop de Bambey. Ce tableau de bord est votre portail pour gérer efficacement les avis de recrutement et les dossiers de candidature. En tant que DRH, vous avez les rôles et responsabilités suivants :</p>

        <h2>Lancement d'Avis de Recrutement</h2>
        <p>Publiez des avis de recrutement pour attirer les meilleurs talents dans notre université.</p>

        <h2>Regroupement des Dossiers de Candidature</h2>
        <p>Centralisez et organisez les dossiers de candidature pour faciliter le processus de sélection.</p>

        <h2>Consultation des Descriptions de Postes</h2>
        <p>Visualisez les descriptions de postes envoyées par les chefs de département pour mieux comprendre les besoins en personnel de chaque département.</p>

        <p>Nous vous remercions pour votre engagement à maintenir un haut niveau de qualité dans le recrutement et la gestion des ressources humaines de notre université.</p>
    </div>
</div>
