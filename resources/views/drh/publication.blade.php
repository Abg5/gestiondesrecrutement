 ...
 <nav class="bg-white-900 dark:bg-white-900 fixed w-full z-20 top-0 start-0 h-20 border-b border-white-900 dark:border-white-900 flex justify-between items-center px-4">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
    ...
    <div class="text-center">
        <h1 class="text-3xl font-bold mb-8">Soumission de l'appel à candidature</h1>
    </div>

    <form method="POST" class="mt-4" action="{{ route('publication') }}"  enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="intituler">Intitulé de l'appel :</label>
            <input type="text" id="intituler" name="intituler" required>
        </div>

        <div class="form-group">
            <label for="departements">Département :</label>
            <select id="departements" name="departements" required>
        ...
        <div class="form-group">
            <label for="heurelimite">Heure limite de la demande :</label>
            <input type="time" id="heurelimite" name="heurelimite" required>
        </div>
        ...
        <div class="form-group">
            <label for="postes">Type de poste :</label>
            <select id="postes" name="postes" required>
                <option value="per">PER'S</option>
                <option value="pats">PATS</option>
            </select>
        </div>
         <div class="mb-4">
            <label for="fichier" class="block text-sm font-medium text-gray-700">Fichier PDF</label>
            <input type="file" name="fichier" id="fichier" class="mt-1 block w-full" accept="application/pdf" required>
        </div>
 @if (session('success'))
    ...
    @endif
        <button type="submit">Publier l'appel</button>
    </form>
