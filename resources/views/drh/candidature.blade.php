                            ...
                            @foreach($candidats as $index => $candidat)
                                <tr>
                                    ...
                                    @if ($postuler->postes==='per')
                                       <td>
                                        <a href="{{ route('voirplus', ['postuler_id' => $postuler->id, 'id' => $candidat->user->id]) }}" class="text-blue-600 dark:text-blue-500 hover:underline transition duration-300 ease-in-out">Voir plus</a>
                                       </td>
                                    @else
                                     <td>
                                        <a href="{{ route('voirpluspats', ['postuler_id' => $postuler->id, 'id' => $candidat->user->id]) }}" class="text-blue-600 dark:text-blue-500 hover:underline transition duration-300 ease-in-out">Voir plus</a>
                                       </td>
