 ...
 <nav class="bg-white-900 dark:bg-white-900 fixed w-full z-20 top-0 start-0 h-20 border-b border-white-900 dark:border-white-900 flex justify-between items-center px-4">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
    ...
    <div class="text-center">
        <h1 class="text-3xl font-bold mb-8">Recrutement des personnels Enseignants</h1>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full bg-white shadow-md rounded mb-4">
            ...
            <tbody>
                @foreach($Profilrecherchers as $Profilrechercher)
                <tr class="border-b">
                    <td class="py-2 px-4">{{ $Profilrechercher->description }}</td>
                    <td class="py-2 px-4">{{ $Profilrechercher->departements }}</td>
                    <td>
                        <a href="{{ route('destroyprofil') }}?id={{ $Profilrechercher->id }}" onclick="return confirm('Voulez-vous vraiment suprimmer cette poste cet utilisateur ?');" class="text-green-600 dark:text-green-500 hover:underline transition duration-300 ease-in-out">Supprimer</a>
