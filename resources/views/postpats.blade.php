...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <h1 ><strong>Recrutement des personnels Administrative et services (PATS)</strong></h1>
        </div>
                ...
                <table class="w-full text-base text-left text-gray-500 dark:text-gray-400 ">
                    <thead class="text-xs text-black-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-black-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Avis de recrutement</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-white-900 even:bg-gray-50 even:dark:bg-white-800 border-b dark:border-gray-700">
                        <td class="font-medium text-gray-900  dark:text-black">{{ $postuler->intituler }}</td>
