            ...
            <table class="w-full text-base text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-black-700 uppercase bg-white-50 dark:bg-gray-700 dark:text-black-400">
                    <tr>
                        ...
                        {{-- <th scope="col" class="px-6 py-3">Fichier Joint</th> --}}
                    </tr>
                </thead>
                <tbody>
                    @foreach($appelcandidatures as $avis)
                    <tr class="odd:bg-white odd:dark:bg-white-900 even:bg-gray-50 even:dark:bg-white-800 border-b dark:border-gray-700">
                        <td class="px-6 py-4 font-medium text-gray-900  dark:text-black">{{ $avis->intituler }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-black">{{ $avis->departements }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-black">{{ $avis->datelimite }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-black">{{ $avis->heurelimite }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-black">{{ $avis->contrat }}</td>
                        {{-- <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-black">
                            <a href="{{ asset('storage/' . $avis->fichier) }}" class="hover:text-blue-700">Télécharger le fichier</a>
                        </td> --}}
                    </tr>
                    @endforeach
                </tbody>
