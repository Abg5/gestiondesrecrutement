...
<head>
 ...
 <style>
        .title-container {
            text-align: center;
            padding: 0px;
            margin-top: i0px; /* Pour déplacer le titre vers le bas */
            border: 1px solid #ccc; /* Cadre autour du titre */
  ...
  <path fill-rule="evenodd" d="M17.447 8.08a1.087 1.087 0 0 1 1.187.238l.002.001a1.088 1.088 0 0 1 0 1.539l-.377.377-1.54-1.542.373-.374.002-.001c.1-.102.22-.182.353-.237Zm-2.143 2.027-4.644 4.644-.385 1.924 1.925-.385 4.644-4.642-1.54-1.54Zm2.56-4.11a3.087 3.087 0 0 0-2.187.909l-6.645 6.645a1 1 0 0 0-.274.51l-.739 3.693a1 1 0 0 0 1.177 1.176l3.693-.738a1 1 0 0 0 .51-.274l6.65-6.646a3.088 3.088 0 0 0-2.185-5.275Z" clip-rule="evenodd"/>
    ...
    <div class="p-4 sm:ml-64 mt-14">
        <div class="p-1 rounded-lg ">
            <div class="flex justify-center py-12 rounded-xl">
       ...
       <div class="flex justify-center">
            <h1 class="text-2xl font-bold"> Enrigistrement du fiche signe par le recteur </h1>
        </div>


        <div class="flex justify-center">
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg ">
                <form class="max-w-sm mx-auto" method="POST" action="{{ route('avis') }}" enctype="multipart/form-data" >
                    @csrf
                            ...
                            <div class="mb-4">
                               <label for="fichier" class="block text-sm font-medium text-gray-700">avis de recrutement</label>
