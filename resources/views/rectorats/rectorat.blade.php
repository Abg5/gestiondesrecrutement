...
<body class="antialiased bg-gray-200 font-body">
  ...
  <path fill-rule="evenodd" d="M17.447 8.08a1.087 1.087 0 0 1 1.187.238l.002.001a1.088 1.088 0 0 1 0 1.539l-.377.377-1.54-1.542.373-.374.002-.001c.1-.102.22-.182.353-.237Zm-2.143 2.027-4.644 4.644-.385 1.924 1.925-.385 4.644-4.642-1.54-1.54Zm2.56-4.11a3.087 3.087 0 0 0-2.187.909l-6.645 6.645a1 1 0 0 0-.274.51l-.739 3.693a1 1 0 0 0 1.177 1.176l3.693-.738a1 1 0 0 0 .51-.274l6.65-6.646a3.088 3.088 0 0 0-2.185-5.275Z" clip-rule="evenodd"/>
                        ...
                        <span class="ms-3">Dossier des candidature</span>
                    </a>
                </li>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-1 rounded-lg ">
            <div class="flex justify-center py-6 rounded-xl">
               ...
               <div class="container">
    <div class="header">
        <h1>Tableau de Bord du Rectorat</h1>
    </div>
    <div class="content">
        <p>Bienvenue sur le tableau de bord du Rectorat de l'Université Alioune Diop de Bambey. Ce tableau de bord est conçu pour faciliter la gestion des appels à candidature et la publication des avis de recrutement. En tant que membre du Rectorat, vous avez les rôles et responsabilités suivants :</p>

        <h2>Réception des Avis de Recrutement</h2>
        <p>Recevez les avis de recrutement rédigés par la Direction des Ressources Humaines.</p>

        <h2>Publication des Avis de Recrutement</h2>
        <p>Publiez les avis de recrutement avec les documents joints afin d'attirer des candidats qualifiés.</p>

        <p>Nous vous remercions pour votre engagement à garantir la transparence et l'efficacité dans le processus de recrutement de notre université.</p>
    </div>
</div>
